...
// PowerSystemSelector Component
function PowerSystemSelector({ selectedSystems, onAddSystem, onRemoveSystem, projectId }: {
  ...
  const availableSystems = magicSystems.filter((system: any) =>
