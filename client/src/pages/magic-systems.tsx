          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-[var(--color-200)] rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg shadow-sm cursor-pointer group">
                <Sparkles className="w-6 h-6 text-[var(--color-700)] transition-transform duration-300 group-hover:rotate-12 group-hover:scale-110" />
              </div>
              <div>
                ...
                <MasonryItem key={i}>
                  ...
                  <div className="p-6 pt-0">
                    <div className="space-y-3">
                      ...
                      <div className="h-3 bg-[var(--color-200)] rounded w-2/3"></div>
                    </div>
                  </div>
                  </Card>
                </MasonryItem>
