            ...
            <div className="animate-pulse">
              ...
              <div className="mb-6">
                <div className="flex items-center space-x-2 mb-3">
                  <div className="w-4 h-4 bg-[var(--color-200)] rounded"></div>
                  <div className="w-12 h-4 bg-[var(--color-200)] rounded"></div>
                </div>
                <div className="flex flex-wrap gap-2">
                  <div className="w-16 h-6 bg-[var(--color-200)] rounded-full"></div>
                  <div className="w-20 h-6 bg-[var(--color-200)] rounded-full"></div>
                  <div className="w-14 h-6 bg-[var(--color-200)] rounded-full"></div>
                </div>
              </div>
              ...
              <Card className="bg-transparent">
                <CardContent className="space-y-6 pt-6">
                  <div>
                    <div className="w-20 h-6 bg-[var(--color-200)] rounded mb-3"></div>
                    <div className="space-y-2">
                      <div className="h-4 bg-[var(--color-200)] rounded w-full"></div>
                      <div className="h-4 bg-[var(--color-200)] rounded w-4/5"></div>
                      <div className="h-4 bg-[var(--color-200)] rounded w-3/4"></div>
                      <div className="h-4 bg-[var(--color-200)] rounded w-5/6"></div>
